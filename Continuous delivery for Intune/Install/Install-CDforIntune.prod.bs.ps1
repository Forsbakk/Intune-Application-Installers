$ScriptLocURI = "https://raw.githubusercontent.com/Forsbakk/Intune-Application-Installers/master/Continuous%20delivery%20for%20Intune/Install/Script.prod.bs.ps1"
...
$ScheduledTaskVersion = "0.0.8.1.prod.bs"
